...
function onValid(event){
    ...
    //appel aux getters
    if(inscription.champNom == "" || inscription.champPrenom == "" || inscription.champEmail == "" || inscription.champPassword == "" || inscription.champNumAdresse == ""|| inscription.champNomAdresse == "" || inscription.champCodePostal == "" || inscription.champVille == "")
    {
        console.log(inscription.champNom);
        console.log(inscription.champPrenom);
        console.log(inscription.champEmail);
        console.log(inscription.champPassword);
        ...
        fetch('includes/core/controllers/inscription_controller.php', {
            method: 'POST',
            body: formData
          })
...
{
    btnInscrip = document.getElementById("btnInscrip");

    btnInscrip.addEventListener("click",onValid);
