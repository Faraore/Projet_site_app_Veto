<div class="containerCard1">
  <div class="card">
    ...
    <div class="card-body">
      <h2 class="tag tagCompagnon">Ajouter un ou plusieurs compagnons</h2>
      <p>
...
<div class="containerCard2">
  <div class="card">
    ...
    <div class="card-body">
      <h2 class="tag tagSuivi">Suivez vos animaux !</h2>
      <p>
...
<div class="containerCard3">
  <div class="card">
    ...
    <div class="card-body">
      <h2 class="tag tagAgenda">N’oubliez plus le rappel de vaccins </h2>
      <p>
...
<div class="containerCard4">
  <div class="card">
    ...
    <div class="card-body">
      <h2 class="tag tagVeto">Trouvez le vétérinaire le plus proche </h2>
      <p>
